<div align="center">
  ...
  <a href="https://github.com/shanguyah">
    <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=600&size=22&pause=1000&color=e94560&center=true&vCenter=true&random=false&width=600&lines=Full+Stack+Architect+%F0%9F%A7%B1;Network+Infrastructure+Lead+%F0%9F%8C%90;M-Pesa+FinTech+Innovator+%F0%9F%92%B3;Founder+%40+Laced+%26+Lit+%F0%9F%9B%8D%EF%B8%8F;CRM+%26+Customer+Lifecycle+Expert;Scaling+Digital+Commerce+%F0%9F%9A%80;JavaScript+%7C+Python+%7C+TypeScript+Dev" alt="Typing SVG" />
  </a>
...
- 📈 **Strategy:** Automated CRM workflows to personalize user journeys.
...
<p align="left">
  <a href="https://github.com/shanguyah">
    <img src="https://skillicons.dev/icons?i=nodejs,express,python,django,php,laravel,java,mysql,postgres,mongodb,firebase&perline=11" />
  </a>
</p>
...
| :--- | :--- | :--- | :---: |
| **[Laced & Lit](https://github.com/shanguyah)** | Live premium streetwear store with CRM-driven customer flows | `Node.js` `React` `Tailwind` | 🟢 Live |
| **[SecurePay Hub](https://github.com/shanguyah)** | M-Pesa STK automation with real-time transaction tracking | `MongoDB` `Express` `JWT` | 🟢 Active |
| **[Network Guard](https://github.com/shanguyah)** | Hardened infrastructure for secure data processing | `Linux` `Bash` `Wireshark` | 🔵 Stable |
...
```
┌─────────────────────────────────────────────────────┐
│  valentine@dev:~$ ping github.com/shanguyah         │
│  > Protocol    : HTTPS / TCP/IP                     │
│  > Infra       : AWS · GCP · Nginx · Docker         │
│  > OS          : Ubuntu Server / CentOS             │
│  > Tools       : Wireshark · Bash · SSH             │
│  > FinTech     : M-Pesa STK · Daraja API · JWT      │
│  > Status      : ONLINE ✓                           │
└─────────────────────────────────────────────────────┘
```
...
<a href="https://github.com/shanguyah">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=13&pause=800&color=00d2ff&center=true&vCenter=true&width=500&lines=%24+git+push+origin+main+%E2%9C%93;%24+docker+build+%26%26+deploy+%E2%9C%93;%24+npm+run+prod+%E2%9C%93;%24+python+manage.py+runserver+%E2%9C%93;%24+wireshark+-i+eth0+%E2%9C%93" />
</a>
...
<a href="https://github.com/shanguyah">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:0f3460,50:16213e,100:1a1a2e&height=100&section=footer&reversal=true" width="100%" />
</a>
